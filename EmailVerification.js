        ...
        const loginLink = (
          <div className={classes.paragraphContainer}>
            <p className={classes.para}>
              If you have succesfully confirmed, try logging in <Link to="/login"  style={{color: "#6200ee", fontWeight: 500 }}>here</Link>. 
        ...
        return (
          <div className={classes.pageContainer}>
            ...
            <Paper className={classes.contentContainer}>
              ...
              <div className={classes.paragraphContainer}>
                <p className={classes.para}>
                  { this.state.emailSent ? "Please check your inbox again for the confirmation email." : "Please check your inbox for the confirmation email. Or if you haven't found one, click resend to get another verification email." }
                </p>
              </div>
              { this.state.emailSent ? loginLink : resetForm }              
            </Paper>
          </div>
        )
    }
...
export default withStyles(styles)(connect(null, mapDispatch)(VerifyEmail));
